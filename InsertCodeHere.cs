...
namespace CarDealershipV05
{
    public class InsertCodeHere
    {
        public void MyCode()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("carNo1: " + carNo1);
            Console.WriteLine("carNo2: " + carNo2);
            Console.WriteLine("carNo3: " + carNo3);
            Console.WriteLine("carNo4: " + carNo4);
            Console.WriteLine("carNo5: " + carNo5);
